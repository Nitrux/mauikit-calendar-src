 ...
 * We can use it to create new incidences, or wrap pre-existing incidences,
 * to more cleanly pass around to QML or to CalendarManager.
 */

class CALENDAR_EXPORT IncidenceWrapper : public QObject
{
    Q_OBJECT
    QML_ELEMENT
